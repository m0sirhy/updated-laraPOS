                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('dashboard.clients.orders.update', ['order' => $order->id, 'client' => $client->id]) }}" method="post">
                            ...
                            <h4>@lang('site.discount') : <input type="number" name="discount" class=" form-control input-sm discount" min="0" value="{{$order->discount}}"></h4>

                            <h4>@lang('site.total') : <span class="total-price">{{ number_format($order->total_price, 2) }}</span>
