            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('dashboard.suppliers.purchaces.store', $supplier->id) }}" method="post">
                            ...
                            <button class="btn btn-primary btn-block disabled" id="add-purchace-form-btn"><i class="fa fa-plus"></i> @lang('site.add_purchace')</button>
