                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.outlays.update', $product->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" step="0.01" class="form-control" value="{{  $outlays->amount }}">
                        </div>

                        <div class="form-group">
                            <label>@lang('site.payee')</label>
                            <input type="text" name="payee"  class="form-control" value="{{ $outlays->payee}}">
                        </div>

                        <div class="form-group">
                                <label>@lang('site.description')/البيان</label>
                                <textarea name="statment" class="form-control ckeditor">{{ $outlays->statment}}</textarea>
                            </div>
